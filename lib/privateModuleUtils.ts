...
import { getProdConfig } from './getConfig';
import { getAWSAccounts } from './getAWSAccounts';
import { ROOT_DIR } from './directoryUtils';
...
export async function useCodeArtifact({
  ...
  if (updatePackageLock) {
    ...
    console.log('updating package-lock file. this will be few moments');
...
export async function getCAConfig() {
